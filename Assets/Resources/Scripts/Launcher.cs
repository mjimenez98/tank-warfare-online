...
namespace Com.TankWarfareOnline
{
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        /// of this to properly adjust the behavior when we receive call back by Photon.
        ...
        public void Connect()
        {
            ...
            // from the game we will get a callback that we are connected, so we
            // need to know what to do then
